...
class Board():
    ...
    def place_stone(self, player, point):
        ...
        # first, examine direct neighbors
        ...
        '''
        if any opposite color string now has 0 liberties, remove them
        '''
        for other_color_string in adjacent_opposite_color:
...
class GameState():
    def __init__(self, board, next_player, previous, move):
        ...
        if self.previous_state is None:
            ...
            self.previous_state = frozenset(
                previous.previous_state | {(previous.next_player, previous.board.zobrist_hash())})
        self.last_move = move
